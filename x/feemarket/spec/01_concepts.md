...
The more complex operations a transaction requires, the higher the gasLimit (See [Executing EVM bytecode](https://docs.streakk.org/modules/evm/01_concepts.html#executing-evm-bytecode)).
...
You might encounter both terminologies on streakk since it builds Ethereum on top of the SDK,
...
Instead of burning the base fee (as implemented on Ethereum), the `feemarket` module allocates the base fee for regular [Cosmos SDK fee distribution](https://docs.streakk.org/modules/distribution/).
...
Have a look at the [mempool](https://docs.streakk.org/validators/setup/mempool.html) docs to read more about how to leverage transaction prioritization.
