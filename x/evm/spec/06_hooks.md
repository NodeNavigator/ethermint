...
## Use Case: Call Native ERC20 Module on streakk

Here is an example taken from the streakk [erc20 module](https://docs.streakk.org/modules/erc20/) that shows how the `EVMHooks` supports a contract calling a native module to convert ERC-20 Tokens into Cosmos native Coins. Following the steps from above.
