...
SIMAPP = ./app
HTTPS_GIT := https://github.com/streakk-maker/ethermint.git
...
PACKAGE_NAME:=github.com/streakk-maker/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/streakk-maker/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/streakk-maker/ethermint/tests/importer
